...
factor_TEC = ((GPS_L1 * GPS_L2) ** 2) / (GPS_L1 + GPS_L2) \
             / (GPS_L1 - GPS_L2) / A / TECU  # m to tecu
factor = (GPS_L1 - GPS_L2) / (GPS_L1 + GPS_L2) / SPEED_OF_LIGHT
factor_mw = (GPS_L1 * GPS_L2) / (GPS_L2 - GPS_L1) / SPEED_OF_LIGHT